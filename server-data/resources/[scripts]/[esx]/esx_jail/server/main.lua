...
-- jail command
TriggerEvent('es:addGroupCommand', 'hapseat', 'admin', function(source, args, user)
	if args[1] and GetPlayerName(args[1]) ~= nil and tonumber(args[2]) then
		TriggerEvent('esx_jail:sendToJail2', tonumber(args[1]), tonumber(args[2] * 60))
	else
...
RegisterServerEvent('esx_jail:sendToJail2')
AddEventHandler('esx_jail:sendToJail2', function(target, jailTime)
