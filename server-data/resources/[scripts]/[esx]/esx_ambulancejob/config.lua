...
Config.RespawnPoint = {coords = vector3(321.98, -591.03, 43.28), heading = 48.5}
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(299.02, -584.86, 43.26),
			sprite = 489,
			scale  = 0.8,
			color  = 1
		},
		...
		Vehicles = {
			{
				Spawner = vector3(293.59, -597.38, 43.26),
				InsideShop = vector3(285.83, -612.12, 43.11),
				Marker = {type = 36, x = 1.0, y = 1.0, z = 1.0, r = 100, g = 50, b = 200, a = 100, rotate = true},
				SpawnPoints = {
					{coords = vector3(288.50, -602.85, 42.94), heading = 328.90, radius = 4.0}
				}
			}
		},
